...
# messages.to_csv(r'C:\Users\vbhoj\Downloads\NLP\Spam Classfier\spamdata.csv', index = False)

messages = pd.read_csv(r"C:\Users\vbhoj\Downloads\NLP\Spam Classfier\spamdata.csv")
